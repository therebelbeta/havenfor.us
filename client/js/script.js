	...
	$(document).ready(function () {
	  ...
	  Pace.on('hide', function () {
	    ...
	    if (!device.tablet() && !device.mobile()) {
	      $gallery.masonry('on', 'layoutComplete', function (msnryInstance, laidOutItems) {
	        $.waypoints('refresh');
	      })
	    }
	  ...
	  $(".popup-map, #map-menu").click(function (e) {
	    ...
	    $("#location").show(0, function () {
	      $("#location_map").gMap({
	        ...
	        markers: [{
	          latitude: 40.724734,
	          longitude: -111.766416,
	          html: "<strong>Ceremony + Reception</strong><br/>"+
              "Louland Falls<br/>Highway 80, Exit 131<br/>"+
              "<strong><a href='http://loulandfalls.com/wp-content/uploads/2015/01/18-2-page/Louland_Falls_map.jpg' target='_blank'>Directions</a> | "+
              "<a href='https://www.google.com/maps/place/Louland+Falls/@40.72486,-111.766319,17z/data=!3m1!4b1!4m2!3m1!1s0x875260d3f6a7d747:0xdbc933e96bd98ed7' target='_blank'>Google Maps</a></strong><br/>"+
              "<strong>GPS:</strong> 40.724734, -111.766416",
	          popup: true,
	        }],
	        panControl: true,
	        zoomControl: true,
